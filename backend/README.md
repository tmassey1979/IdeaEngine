...
- stage-aware heartbeat content that shows the current stage and latest stage outcome
...
That heartbeat now includes the current stage and the latest recorded stage outcome.
