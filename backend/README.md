...
- Codex CLI-first execution for model-backed agents
...
- local Codex CLI execution for unattended agent work
...
- model-backed agents run through the local `codex` CLI
- generated/runtime containers need `codex` installed alongside the .NET process
