...
public sealed class PlannerTests
{
    ...
    public void WriteStatus_IncludesLatestPassSummaryWhenProvided()
    {
        ...
        var snapshot = loop.WriteStatus(outputPath, "run-polling", "polling", "waiting", nextPollAt, null, 0, latestPass);
    ...
    public void WriteStatus_IncludesPollIntervalSecondsWhenProvided()
    {
        ...
        var snapshot = loop.WriteStatus(outputPath, "run-watch", "watch", "waiting", DateTimeOffset.UtcNow.AddSeconds(30), 15, 2);
