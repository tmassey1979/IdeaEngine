...
public sealed class PlannerTests
{
    ...
    public void SyncValidatedWorkflow_TrimsChangedPathsBeforeClosing()
    {
        ...
        var records = new[]
        {
            new ExecutionRecord(104, "System Architecture", "developer", "implement_issue", "job-dev", "success", "done", DateTimeOffset.UtcNow, [" docs/ARCHITECTURE.md ", "docs/ARCHITECTURE.md", "DOCS/ARCHITECTURE.md", "docs\\ARCHITECTURE.md", "./docs/ARCHITECTURE.md", "docs//ARCHITECTURE.md", "docs/./ARCHITECTURE.md", "docs/../docs/ARCHITECTURE.md", "./docs/../docs/ARCHITECTURE.md", "../outside.txt", "./docs/../../outside.txt", "/etc/passwd", "D:/elsewhere/outside.txt", "file:///tmp/outside.txt", "https://example.com/outside.txt", "file:outside.txt", "data:text/plain,hello", "docs/ARCHITECTURE.md?ref=runner", "docs/ARCHITECTURE.md#L10", "docs/ARCHITECTURE.md?ref=runner#L10", "docs/ARCHITECTURE.md&amp;ref=runner", "docs/ARCHITECTURE.md&#35;L10", "`docs/ARCHITECTURE.md`", "[docs/ARCHITECTURE.md]", "\"docs/ARCHITECTURE.md\"", "'docs/ARCHITECTURE.md'", "<docs/ARCHITECTURE.md>", "[Architecture](docs/ARCHITECTURE.md)", "[Architecture](docs/ARCHITECTURE.md \"doc\")", "[Architecture](docs/ARCHITECTURE.md 'doc')", "[Architecture](<docs/ARCHITECTURE.md>)", "[Architecture](<docs/ARCHITECTURE.md> \"doc\")", "[Architecture](<docs%2FARCHITECTURE.md>)", "[Architecture](<docs%2FARCHITECTURE.md> \"doc\")", "docs/ARCHITECTURE%2Emd", "docs%2FARCHITECTURE.md", "docs/ARCHITECTURE.md/.", "docs/ARCHITECTURE.md/", "/mnt/c/code/Playground/IdeaEngine/docs/ARCHITECTURE.md", "C:/code/Playground/IdeaEngine/docs/ARCHITECTURE.md"], ["review"]),
