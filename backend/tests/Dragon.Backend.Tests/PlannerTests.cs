...
public sealed class PlannerTests
{
    ...
    public void SyncValidatedWorkflow_DoesNotCloseIssueWhenChangedPathsEscapeRepo()
    {
        ...
        var records = new[]
        {
            new ExecutionRecord(105, "System Architecture", "developer", "implement_issue", "job-dev", "success", "done", DateTimeOffset.UtcNow, ["../outside.txt", "./docs/../../outside.txt", "/etc/passwd", "D:/elsewhere/outside.txt", "file:///tmp/outside.txt", "https://example.com/outside.txt"], ["review"]),
