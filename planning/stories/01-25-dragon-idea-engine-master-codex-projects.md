# [Story] Dragon Idea Engine Master Codex: Projects
...
- [ ] The Projects behavior is implemented according to the codex definition.
- [ ] The implementation covers these codex details: repositories, health status, activity.
